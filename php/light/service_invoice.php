...
$aid=$_POST['userKey'];
$srid=$_POST['serviceId'];
$service_ref="SR-".str_pad($srid, 5, 0, STR_PAD_LEFT);
include("../connection.php");
$flag=0;
$service=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM service WHERE srid='$srid'"));
$serviceinvoice=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM serviceinvoice WHERE srid='$srid'"));
$ssid = "SE-".str_pad($serviceinvoice['sriid'], 5, 0, STR_PAD_LEFT);
$cid=$service['cid'];
$srcr=$service['srcr'];
$brid=$service['brid'];
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" onload="avatarLoad()">
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <form style="display: none;" id="lightForm" action="../dark/service_invoice.php" method="POST">
                        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                        </form>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:homeBtn()">Home</a>
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:toDo()">Service</a>
                                    </li>
            ...
            <div class="content-body">
                    ...
                    <div class="row">
                        <fieldset class="col-12 col-md-5 mb-1 mb-md-0">
                            <div class="input-group">
                                <input type="text" class="form-control" id="emailaddressTxt" placeholder="Email" value="<?php echo $customer['cemail']; ?>" aria-describedby="button-addon2">
                                <div class="input-group-append" id="button-addon2">
                                    <button class="btn btn-outline-primary" onclick="sendmailBtn()">Send Invoice</button>
                                </div>                                
                            </div>
                        </fieldset>
                ...
                <form action="#" method="POST" id="sendmailFrom">
                <input value="SET" id="sendmail" name="sendmail" style="display: none;">
                <input value="SET" id="emailaddress" name="emailaddress" style="display: none;">
                <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                <input value='<?php echo $srid; ?>' id="serviceId" name="serviceId" style="display: none;">
                </form>
                <script text="javascript">
                    function sendmailBtn() {
                        document.getElementById("emailaddress").value = document.getElementById("emailaddressTxt").value;
                        document.getElementById("sendmailFrom").submit();
                    };
                </script>
                ...
                <section class="card invoice-page">
                    <div id="invoice-template" class="card-body">
                        ...
                        <div id="invoice-company-details" class="row">
                            <div class="col-sm-6 col-12 text-left pt-1">
                                <div class="media pt-1">
                                    <img src="../../img/logo_small.png" alt="company logo"/>
                                </div>
                            </div>
                            <div class="col-sm-6 col-12 text-right">
                                ...
                                <div class="invoice-details mt-2">
                                    ...
                                    <p><?php 
                                    $invoicedate=date("d-M-Y", strtotime($serviceinvoice['dates']));
                                    echo $invoicedate;
                                    ?></p>
                                    <h6 class="mt-2">BILLED BY</h6>
                                    <p><?php
                                    $saler=$serviceinvoice['aid'];
                                    $saler1=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM actdetails WHERE aid='$saler'"));
                                    echo $saler1['fname'] ." " .$saler1['lname'];
                                    ?></p>
                                    <h6>SERVICE REF</h6>
                                    <p><?php echo $service_ref; ?></p>
                                </div>
                            </div>
                        </div>
                        <!--/ Invoice Company Details -->
                        ...
                        <div id="invoice-customer-details" class="row pt-2">
                            <div class="col-sm-6 col-12 text-left">
                                ...
                                <div class="recipient-info my-2">
                                    <p><?php                                    
                                    echo $customer['cname'];?></p>
                                    <p><?php echo $customer['cads'];?></p>
                                </div>
                                <div class="recipient-contact pb-2">
                                    <p>
                                        <i class="feather icon-mail"></i>
                                        <?php echo $customer['cemail'];?>
                                    </p>
                                    <p>
                                        <i class="feather icon-phone"></i>
                                        +91 <?php echo $customer['cphone'];?>
                                    </p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-12 text-right">
                                ...
                                <div class="company-info my-2">
                                    ...
                                    <?php
                                    $branch=$service['brid'];
                                    $branch1=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM actdetails WHERE aid='$branch'"));
                                    echo $branch1['fname'] ." " .$branch1['lname'];
                                    ?>
                                    </p>
                                    <p>
                                    <?php
                                        echo $branch1['ads1'] .", " .$branch1['ads2'];
                                    ?></p>
                                    <p>
                                    <?php
                                        echo $branch1['pincode'];
                                    ?></p>
                                </div>
                                <div class="company-contact">
                                    <p>
                                        <i class="feather icon-mail"></i>
                                        <?php
                                        $email=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM account WHERE aid='$branch'"));
                                        echo $email['email'];
                                        ?>
                                    </p>
                                    <p>
                                        <i class="feather icon-phone"></i>
                                        +91 <?php echo $branch1['pno'];?>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive col-12">
                                    <table class="table table-borderless">
                                        ...
                                        if(mysqli_num_rows($mdk)>0){
                                            foreach($mdk as $kdm){
                                                $incent = intval($kdm['incentive']);
                                                $dis = floatval($kdm['discount']);
                                                $pfr = intval($kdm['cost']);
                                                $cost = ($incent/100)*$pfr;
                                                $tcost = $cost+$incent;
                                                $amount = round(($cost/$dis)+$incent);
                                                ?>
                                                <tr>
                                                    <td>
                                                        <?php echo $kdm['invdetails'];?>
                                                    </td>
                                                    <td>
                                                        <?php echo $tcost;?>
                                                    </td>
                                                    <td>
                                                        <?php echo ($tcost-$amount);?>
                                                    </td>
                                                    <td>
                                                        <?php echo $amount;?>
                                                    </td>
                                                ...
                                                <?php
                                                $subtotal = $subtotal + $tcost;
                                                $tdiscount = $tdiscount + ($tcost-$amount);
                                                $total = $total + $amount;
                                                $tablecontent.='                                            
                                                <tr>
                                                    <td style="text-align: left; border: 1px solid #ddd;  border-collapse: collapse; padding: 15px;">'.$kdm['invdetails'].'</td>
                                                    <td style="text-align: center; border: 1px solid #ddd;  border-collapse: collapse; padding: 15px;">'.$tcost.'</td>
                                                    <td style="text-align: center; border: 1px solid #ddd;  border-collapse: collapse; padding: 15px;">'.($tcost-$amount).'</td>
                                                    <td style="text-align: center; border: 1px solid #ddd;  border-collapse: collapse; padding: 15px;">'.$amount.'</td>                                        
                                                </tr>';
                                            }
                                        }
                                        ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    <th>SUBTOTAL</th>
                                                    <td><?php echo $subtotal;?> INR</td>
                                                </tr>
                                                <tr>
                                                    <th>DISCOUNT</th>
                                                    <td><?php echo $tdiscount;?> INR</td>
                                                </tr>
                                                <tr>
                                                    <th>TOTAL</th>
                        ...
                        <div id="invoice-footer" class="text-center pt-3">
                            <p>For more information, please contact us : <?php echo $email['email'] ." or +91 " .$branch1['pno'] .".";?>
                                <p class="bank-details mb-0">
                                    <span class="mr-4">We hope for a long business relationship with you . <strong>Thank you !</strong></span>
                                </p>
                        </div>
                        <!--/ Invoice Footer -->
    ...
    if(isset($_POST['sendmail'])){
        $page = file_get_contents('../../html/service_invoice.html');
        $page = str_replace('{service_ref}', $service_ref, $page);
        $page = str_replace('{billedby}', $saler1['fname'] ." " .$saler1['lname'], $page);
        $page = str_replace('{tablecontent}', $tablecontent, $page);
        $page = str_replace('{subtotal}', $subtotal, $page);
        $page = str_replace('{discount}', $tdiscount, $page);
        $page = str_replace('{total}', $total, $page);
        $page = str_replace('{branch}', $email['email'] ." or +91 " .$branch1['pno'].".", $page);
        if(isset($_POST['emailaddress'])){
            $emailAds=$_POST['emailaddress'];
        }else{
            $emailAds=$customer['cemail'];
        }
        $mail = new PHPMailer(true);
            ...
            $mail->addAddress( $emailAds, $customer['cname']); // Add a recipient
        
            // Content
            $mail->isHTML(true); // Set email format to HTML
            $mail->Subject = 'Automated BPM: '.$ssid;
            $mail->Body =$page;
