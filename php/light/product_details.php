...
if(isset($_POST['pdtAdd'])){
    $pdtname=$_POST['pdtName'];
    $pdtDetails=$_POST['pdtDetails'];
    $flag=1;    
    if(mysqli_query($con, "INSERT INTO product (pdtname, pdtdetails) VALUES ('$pdtname','$pdtDetails')"))
        $flag=2;
}
if(isset($_POST['pdtEdit'])){
    $pdtname=$_POST['pdtName'];
    $pdtDetails=$_POST['pdtDetails'];
    $pdtid=$_POST['pdtId'];
    $flag=3;
    if(mysqli_query($con, "UPDATE product SET pdtname='$pdtname', pdtdetails='$pdtDetails' WHERE pdtid='$pdtid'"))
        $flag=4;
}
if(isset($_POST['pdtDet'])){
    $pdtid=$_POST['pdtId'];
    $flag=5;
    if(mysqli_query($con, "DELETE FROM product WHERE pdtid='$pdtid'"))
        $flag=6;
}
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <form style="display: none;" id="lightForm" action="../dark/product_details.php" method="POST">
                        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                        </form>
                        <script type="text/javascript">
                            ...
                            function avatarLoad(){
                                ...
                                if(x==1){                                    
                                    ...
                                    toastr.error("Product created failed..", "Well Done !");
                                }else if(x==2){                                    
                                    toastr.options = {
                                    "progressBar": true,
                                    "positionClass": "toast-bottom-right"
                                    };
                                    toastr.success("Product created successfully..", "Well Done !");
                                }else if(x==3){                                    
                                    toastr.options = {
                                    "progressBar": true,
                                    "positionClass": "toast-bottom-right"
                                    };
                                    toastr.error("Product updated failed..", "Well Done !");
                                }else if(x==4){                                    
                                    toastr.options = {
                                    "progressBar": true,
                                    "positionClass": "toast-bottom-right"
                                    };
                                    toastr.success("Product updated successfully..", "Well Done !");
                                }else if(x==5){                                    
                                    toastr.options = {
                                    "progressBar": true,
                                    "positionClass": "toast-bottom-right"
                                    };
                                    toastr.error("Product deleted failed..", "Well Done !");
                                }else if(x==6){                                    
                                    toastr.options = {
                                    "progressBar": true,
                                    "positionClass": "toast-bottom-right"
                                    };
                                    toastr.success("Product deleted successfully..", "Well Done !");
                                }                                 
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a href="javascript:Proddt()" style="display: none;" id="pDt"><i class="feather icon-shopping-bag"></i><span class="menu-title">Product Details</span></a>
                ...
                <section>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="float-right">
                            <button type="sumbit" data-toggle="modal" data-target="#pdtBox" id="pdtadder"  class="btn btn-outline-success round">Add Product</button>
                        </div>
                    </div>
                </section>
            <script type="text/javascript">
                ...
                document.getElementById("pdtadder").onclick = function() {
                    document.getElementById("pdtBoxname").innerHTML = "Add Product";
                    document.getElementById("pdtEdit").style.display = "none";
                    document.getElementById("pdtDet").style.display = "none";
                    document.getElementById("pdtAdd").style.display = "block";
                    document.getElementById("pdtName").value="";
                    document.getElementById("pdtDetails").value="";                    
                };
            </script>                
                    <?php
                    if(!isset($_POST['searchName'])){?>
                    ...
                    <section id="wishlist" class="grid-view wishlist-items"><?php
                        $esr = mysqli_query($con, "SELECT * FROM product ORDER BY product.pdtname ASC");
                            ...
                            <div class="card-content">                            
                                <div class="card-body">                                
                                    <div class="item-img text-center">
                                        <a data-toggle="modal" data-target="#pdtBox" id="pdtEdit<?php echo $stmt['pdtid']; ?>">                                
                                        <img src="../../img/products.png" class="img-fluid" alt="img-placeholder">
                                        </a>                                
                                    </div>
                                    <div class="item-name">
                                        <a data-toggle="modal" data-target="#pdtBox" id="pdtEdit<?php echo $stmt['pdtid']; ?>">
                                            <?php echo $stmt['pdtname'] ?>
                                        </a>
                                    </div>
                                    <div>
                                        <p class="item-description">
                                            <?php echo $stmt['pdtdetails'] ?>
                                        </p>
                                    </div>
                                </div>
                                <input value='<?php echo $stmt['pdtid']; ?>' id="pdtid<?php echo $stmt['pdtid']; ?>" style="display: none;">
                                <input value='<?php echo $stmt['pdtname']; ?>' id="name<?php echo $stmt['pdtid']; ?>" style="display: none;">
                                <input value='<?php echo $stmt['pdtdetails']; ?>' id="details<?php echo $stmt['pdtid']; ?>" style="display: none;">
                                <div class="item-options text-center">                                
                                    <div class="cart move-cart" data-toggle="modal" data-target="#pdtBox" id="pdtDet<?php echo $stmt['pdtid']; ?>">                                    
                                        <i class="feather icon-x align-middle"></i> Remove                                    
                                    </div>
                                </div>
                                <script type="text/javascript">
                                    document.getElementById("pdtDet<?php echo $stmt['pdtid']; ?>").onclick = function() {
                                        document.getElementById("pdtBoxname").innerHTML = "Delete Product";
                                        document.getElementById("pdtEdit").style.display = "none";
                                        document.getElementById("pdtDet").style.display = "block";
                                        document.getElementById("pdtAdd").style.display = "none";
                                        document.getElementById("pdtName").value = document.getElementById("name<?php echo $stmt['pdtid']; ?>").value;
                                        document.getElementById("pdtDetails").value = document.getElementById("details<?php echo $stmt['pdtid']; ?>").value;
                                        document.getElementById("pdtId").value = document.getElementById("pdtid<?php echo $stmt['pdtid']; ?>").value;
                                    };
                                    document.getElementById("pdtEdit<?php echo $stmt['pdtid']; ?>").onclick = function() {
                                        document.getElementById("pdtBoxname").innerHTML = "Edit Product";
                                        document.getElementById("pdtEdit").style.display = "block";
                                        document.getElementById("pdtDet").style.display = "none";
                                        document.getElementById("pdtAdd").style.display = "none";
                                        document.getElementById("pdtName").value = document.getElementById("name<?php echo $stmt['pdtid']; ?>").value;
                                        document.getElementById("pdtDetails").value = document.getElementById("details<?php echo $stmt['pdtid']; ?>").value;
                    ...
                    <section id="wishlist" class="grid-view wishlist-items"><?php
                        ...
                        $esr = mysqli_query($con, "SELECT * FROM product WHERE pdtname LIKE '%{$memil}%' OR pdtdetails LIKE '%{$memil}%' ORDER BY product.pdtname ASC");
                        if(mysqli_num_rows($esr)>0){   
                            foreach($esr as $stmt){?>
                            <div class="card ecommerce-card">
                            <div class="card-content">                            
...
<div class="modal fade text-left" id="pdtBox" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="pdtBoxname"></h4>
            ...
            <div class="modal-body">
                ...
                <div class="input-group">
                    <div class="row">
                        ...
                        <img src="../../img/products.png" class="img-fluid" alt="img-placeholder" height="100%" width="100%">
                        </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="col-12 d-flex mt-1 px-0">
                                <button class="btn btn-outline-primary mr-75  float-left" disabled>Change</button>
                                <button class="btn btn-outline-danger mr-75  float-left" disabled>Remove</button>
                            </div>
                            <label>Since the website is free hosted, you can't change the product picture.</label>
                        </div>                    
                    </div>
                </div>
                <div class="my-1">
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="pdtName" id="pdtName" placeholder="Product Name" value="" required>
            </div>
            <label>Product Description</label>
            <div class="form-group">
                <fieldset class="form-group">
                    <textarea class="form-control" name="pdtDetails" id="pdtDetails" rows="5" placeholder="Product Description" value="" required></textarea>
                </fieldset>
            </div>
        </div>
        <div class="modal-footer">
        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
        <input id="pdtId" name="pdtId" style="display: none;">
        <button type="sumbit" name="pdtAdd" id="pdtAdd" class="btn btn-success" style="display: none;">Add</button>
        <button type="sumbit" name="pdtEdit" id="pdtEdit" class="btn btn-warning" style="display: none;">Edit</button>
        <button type="sumbit" name="pdtDet" id="pdtDet" class="btn btn-danger" style="display: none;">Delete</button>
        </div>        
            </form>
        </div>
    </div>
