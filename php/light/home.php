            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <form style="display: none;" id="lightForm" action="../dark/home.php" method="POST">
                        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                        </form>
                            ...
                            <div class="card bg-analytics text-white">
                                <div class="card-content">
                                    <div class="card-body text-center">
                                        <img src="../../img/decore-left.png" class="img-left" alt="card-img-left">
                                        <img src="../../img/decore-right.png" class="img-right" alt="card-img-right">
                                        ...
                                        <div class="text-center">
                                            <h1 class="mb-2 text-white">Congratulations <?php echo $row['fname']; ?>,</h1>
                                            <p class="m-auto w-75">Now you are also a member of <strong>Automated Business Process Management</strong> . Enjoy being a part of us.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
