...
if(isset($_POST['rSbtn'])){
        $stat="select aid from actdetails where utype='Management'";
        $soln = mysqli_query($con, $stat);
        $msgTxt=$_POST['messageTxt'];
        $msgTit=$_POST['subjectTxt'];
        foreach($soln as $utype){
            $sln=$utype['aid'];
            if(mysqli_query($con,"INSERT INTO notificat (aid, nsub, ntitle, nstatus, ntype, nsender) VALUES ('$sln', '$msgTxt', '$msgTit', '0', 'Access Control Request','$aid')")){
                $select=0;
            }
            else{
                $select=1;
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <form style="display: none;" id="lightForm" action="../dark/access_control.php" method="POST">
                        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                        </form>
                        <script type="text/javascript">                            
                            ...
                            function avatarLoad(){
                                ...
                                var x='<?php echo $flag; ?>';
                                if(x==1){
                                    swal("Well Done...","Request send successful.","success");
                                }
                                else if(x==2){
                            ...
                            function navBar() {
                                if('<?php echo $row['utype']; ?>'=="Management"){
                                    ...
                                    document.getElementById("pDtN").style.display = "block";
                                    document.getElementById("pDtA").style.display = "block";
                                    document.getElementById("pDtE").style.display = "block";
                                    document.getElementById("pDtD").style.display = "block";
                                    document.getElementById("pDtB").style.display = "block";
                                    document.getElementById("eMp").style.display = "block";
                                    document.getElementById("eMpD").style.display = "block";
                                    document.getElementById("eMpF").style.display = "block";
                                    document.getElementById("eMpG").style.display = "block";
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active nav-item"><a href="javascript:accessCont()" style="display: block;" id="aCs"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Access control</span></a>
                ...
                <li class=" nav-item"><a href="javascript:Empsdt()" style="display: none;" id="eDt"><i class="feather icon-users"></i><span class="menu-title">User Details</span></a>
                <form style="display: none;" id="Empsdt" action="User_details.php" method="POST">
                   <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                </form>
                <script type="text/javascript">
                   function Empsdt(){        
                ...
                <li class=" navigation-header" style="display: none;" id="pDtN"><span>PRODUCT</span>
                </li>
                <li class=" nav-item"><a href="javascript:PdtAdd()" style="display: none;" id="pDtA"><i class="feather icon-file-plus"></i><span class="menu-title">Add</span></a>
                ...
                <form style="display: none;" id="changePass" action="../otp.php" method="POST">
                   <input value='<?php echo $row['fname']; ?>' id="name" name="name" style="display: none;">
                   <input value='<?php echo $eml['email']; ?>' id="email" name="email" style="display: none;">
                   <input value='2' id="id" name="id" style="display: none;">
                </form>
                <script type="text/javascript">
                   function changePass(){        
                ...
                <form style="display: none;" id="PdtAdd" action="product_add.php" method="POST">
                   <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                </form>
                <script type="text/javascript">
                   function PdtAdd(){        
                       document.getElementById("PdtAdd").submit();
                   }
                </script>
                </li>
                <li class=" nav-item"><a href="javascript:pdtEdit()" style="display: none;" id="pDtE"><i class="feather icon-edit-1"></i><span class="menu-title">Edit</span></a>
                <form style="display: none;" id="pdtEdit" action="product_edit.php" method="POST">
                   <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                </form>
                <script type="text/javascript">
                   function pdtEdit(){        
                       document.getElementById("pdtEdit").submit();
                   }
                </script>
                </li>
                <li class=" nav-item"><a href="javascript:pdtDel()" style="display: none;" id="pDtD"><i class="feather icon-trash-2"></i><span class="menu-title">Delete</span></a>
                <form style="display: none;" id="pdtDel" action="product_delete.php" method="POST">
                   <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                </form>
                <script type="text/javascript">
                   function pdtDel(){        
                       document.getElementById("pdtDel").submit();
                   }
                </script>
                </li>
                <li class=" nav-item"><a href="javascript:barcode()" style="display: none;" id="pDtB"><i class="fa fa-qrcode"></i><span class="menu-title">Barcode</span></a>
                <form style="display: none;" id="barcode" action="barcode.php" method="POST">
                   <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                </form>
                <script type="text/javascript">
                   function barcode(){        
                       document.getElementById("barcode").submit();
                   }
                </script>
                </li>
                ...
                <li class=" nav-item"><a href="javascript:grdDt()" style="display: none;" id="eMpG"><i class="fa fa-chart-line"></i><span class="menu-title">Grading Details</span></a>
                <form style="display: none;" id="grdDt" action="grading_details.php" method="POST">
                   <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                </form>
                <script type="text/javascript">
                   function grdDt(){        
                       document.getElementById("grdDt").submit();
                   }
                </script>
                </li>
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Access Control</h2>
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-block">
                    ...
                    <button type="button" data-toggle="modal" data-target="#inlineForm" class="btn btn-outline-warning">Request</button>
                    </div>
                </div>
            </div>            
                            ...
                            <div class="row text-center pt-2">
                                <div class="col-12">                                        
                                    <div class="w-100 mx-auto">
                                        ...
                                        <h5 class="mt-2 font-weight-bold">Your account is blocked !</h5>
                                        <p>Your account is temporarily blocked. Do you want to activate your account access of <b>Automated Business Process Management System ?</b><br> Please send a request.</p>
                                    </div>                                        
                                </div>
                            </div>
                        </div>                                                
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel33">SEND REQUEST</h4>
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" value='<?php echo $eml['email']; ?>' disabled>                                                 
                </div> 
                <label>Subject</label>
        ...
        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
        <button type="sumbit" name="rSbtn" class="btn btn-primary" id="submitbtn">Send</button>
        </div>        
            </form>
        </div>
    </div>
