...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" onload="avatarLoad()">
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <form style="display: none;" id="lightForm" action="../dark/user_details.php" method="POST">
                        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                        </form>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <a href="javascript:usrEdit()" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> Edit</a>
                                            <a href="javascript:deleteAll()" class="btn btn-outline-danger disabled"><i class="feather icon-trash-2"></i> Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- END: Footer-->
    <form style="display: none;" id="delnotiFy" action="user_details.php" method="POST">
    <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
