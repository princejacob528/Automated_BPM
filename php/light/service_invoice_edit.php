...
if(isset($_POST['saveBtn'])){
    ...
    if(mysqli_query($con, "UPDATE service SET stat='5' WHERE srid='$srid'")){
        if(mysqli_query($con, " UPDATE serviceinvoice SET aid='$aid', remarks='$remarks', incentive='$incentive', total='$total' WHERE srid='$srid'")){
            $flag=1;
    ...
    if($flag==1){        
        if(mysqli_query($con, "UPDATE custcredit credit='$total'WHERE ref='$srid')")){
            $flag=3;
        }
    }
}
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <form style="display: none;" id="lightForm" action="../dark/service_invoice_edit.php" method="POST">
                        <input value='<?php echo $aid; ?>' id="userKey" name="userKey" style="display: none;">
                        </form>
                        <script type="text/javascript">
                            ...
                            function avatarLoad(){
                                ...
                                if(x==1){
                                    ...
                                    toastr.error("Service updated failed.", "Oops !");
                                }else if(x==3){
                                    toastr.options = {
                                    "progressBar": true,
                                    "positionClass": "toast-bottom-right"
                                    };
                                    toastr.success("Service and Credit updated successfully.", "Well Done !");
                                }else if(x==4){
                                    toastr.options = {
                                    "progressBar": true,
                                    "positionClass": "toast-bottom-right"
                ...
                <div class="col-12">
                   ...
                   <div class="card-body">
                    ...
                    if(mysqli_num_rows($mdk)>0){
                        foreach($mdk as $kdm){
                            $counter=$counter+1;
                            $incentiver=$incentiver+$kdm['incentive'];
                            ?>
                            <tr>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <input name="invdt[]" value="<?php echo $kdm['invdetails'];?>" type="text" class="form-control">
                                ...
                                <td>
                                    ...
                                    if($kdm['cost']=='100'){
                                        ...
                                        <option value="60" >60%</option>
                                        <option value="40" >40%</option>
                                        <option value="20" selected>20%</option><?php
                                    }
                                    ?>                                        
                                    </select>
                                </td>
                                <td>
                                    ...
                                    if($kdm['discount']=='1'){
                                        ...
                                        <option value="2">5-Level</option><?php
                                    }else if($kdm['discount']=='1.2'){
                                        ?><option value="1">0-Level</option>                                
                                        <option value="1.2" selected>1-Level</option>                                
                                        <option value="1.4">2-Level</option>
                                        <option value="1.6">3-Level</option>                                
                                        <option value="1.8">4-Level</option>                                
                                        <option value="2">5-Level</option><?php
                                    }else if($kdm['discount']=='1.4'){
                                        ?><option value="1">0-Level</option>                                
                                        <option value="1.2">1-Level</option>                                
                                        <option value="1.4" selected>2-Level</option>
                                        <option value="1.6">3-Level</option>                                
                                        <option value="1.8">4-Level</option>                                
                                        <option value="2">5-Level</option><?php
                                    }else if($kdm['discount']=='1.6'){
                                        ?><option value="1">0-Level</option>                                
                                        <option value="1.2">1-Level</option>                                
                                        <option value="1.4">2-Level</option>
                                        <option value="1.6" selected>3-Level</option>                                
                                        <option value="1.8">4-Level</option>                                
                                        <option value="2">5-Level</option><?php
                                    }else if($kdm['discount']=='1.8'){
                                        ?><option value="1">0-Level</option>                                
                                        <option value="1.2">1-Level</option>                                
                                        <option value="1.4">2-Level</option>
                                        <option value="1.6">3-Level</option>                                
                                        <option value="1.8" selected>4-Level</option>                                
                                        <option value="2">5-Level</option><?php
                                    }else if($kdm['discount']=='2'){
                                        ?><option value="1">0-Level</option>                                
                                        <option value="1.2">1-Level</option>                                
                                        <option value="1.4">2-Level</option>
                                        <option value="1.6">3-Level</option>                                
                                        <option value="1.8">4-Level</option>                                
                                        <option value="2" selected>5-Level</option><?php
                                    }
                                    ?>                                        
                                    </select>
                                </td>
                ...
                <div class="row">
                    <div class="col-12 col-sm-5">
                        ...
                        <fieldset class="form-group pl-1">
                            <textarea class="form-control" name="remarks" rows="6" placeholder="Remarks"><?php echo $serviceinvoice['remarks'];?></textarea>
                        </fieldset>
                    </div>
                    <div class="col-12 col-sm-7">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <th>DATE</th>
                                    <td><input type="text" disabled value="<?php echo $serviceinvoice['dates'];?>" name="dates"  class="form-control round"></td>
                                </tr>
                                <tr>
                                    <th>CASH METHOD</th>
                                    <?php
                                    $ttk=mysqli_query($con, "SELECT * FROM custcredit WHERE ref='$srid'");
                                ...
                                <tr>
                                    <th>GRAND TOTAL</th>
                                    <td>
                                        <input type="text" disabled  id="total" value="<?php echo $serviceinvoice['total'];?>" class="form-control round">
                                        <input type="text" name="total"  id="totaler" value="<?php echo $serviceinvoice['total'];?>" style="display: none">
                                        <input type="text" name="incentive" value="<?php echo $incentiver;?>" style="display: none">
                                    </tr>
                            </tbody>
                            </table>
                        </div>
